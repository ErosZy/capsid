#!/usr/bin/env python3
"""A2: aggregate quickjs-ng-opcode-profile-v1 dumps into a candidate
...
arith/branch/call/prop class mix.
...
def load_profiles(path):
    """Yield (mode, opcode_profile_dict) for every dump line."""
        ...
        with open(f, encoding="utf-8", errors="replace") as fh:
            for line in fh:
                ...
                try:
                    ...
                    continue
                if obj.get("schema") != "quickjs-ng-opcode-profile-v1":
                    continue
                yield mode, obj
...
def main():
    ...
    PROP_SLOW = {"get_field", "get_field2", "get_array_el",
                 "get_array_el2", "put_field", "put_array_el"}

    for mode, obj in load_profiles(args.dir):
        ...
        # Property: the "slow" bucket is the generic-path entry.
