...
#ifndef CAPSID_SRC_BYTECODE_REWRITER_IR_CFG_H
#define CAPSID_SRC_BYTECODE_REWRITER_IR_CFG_H
...
// bytecode_rewriter.cc, which owns the strict bundle reader).
struct FuncInfo {
...
// contract as the rewriter's parse: any violation returns false with a
...
#endif  // CAPSID_SRC_BYTECODE_REWRITER_IR_CFG_H
