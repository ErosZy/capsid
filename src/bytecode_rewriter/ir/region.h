...
// single heavy opcode belongs to a runtime fast path, not fusion. The
...
// duplication cost).
#ifndef CAPSID_SRC_BYTECODE_REWRITER_IR_REGION_H
#define CAPSID_SRC_BYTECODE_REWRITER_IR_REGION_H
...
#endif  // CAPSID_SRC_BYTECODE_REWRITER_IR_REGION_H
