...
// test_rewriter Builder layout, including the debug block). Part C
...
// goto16=243, await=138, OP_COUNT=252. Bytes at or above OP_COUNT are
// invalid in BC26.
