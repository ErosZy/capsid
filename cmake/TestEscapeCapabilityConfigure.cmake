...
set(CAPSID_CHILD_COMPILER_ARGS "")
if(DEFINED CAPSID_C_COMPILER)
    list(APPEND CAPSID_CHILD_COMPILER_ARGS
        "-DCMAKE_C_COMPILER=${CAPSID_C_COMPILER}")
endif()
if(DEFINED CAPSID_CXX_COMPILER)
    list(APPEND CAPSID_CHILD_COMPILER_ARGS
